...
import task1_transport.Transport;
...
public abstract class Driver <T extends Transport> {
    ...
    public boolean equals(Object o) {
        ...
        return doesHaveDriverLicense == driver.doesHaveDriverLicense && experience == driver.experience && Objects.equals(name, driver.name);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, doesHaveDriverLicense, experience);
    }
